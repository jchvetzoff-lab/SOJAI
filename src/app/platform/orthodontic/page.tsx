...
import { usePlatformStore, type CephalometricMeasurement } from '@/hooks/usePlatformStore';

const defaultMeasurements: CephalometricMeasurement[] = [
  { name: 'SNA Angle', value: 82.5, unit: 'degrees', normalRange: '80-84°', status: 'normal' },
  { name: 'SNB Angle', value: 78.2, unit: 'degrees', normalRange: '78-82°', status: 'normal' },
  { name: 'ANB Angle', value: 4.3, unit: 'degrees', normalRange: '2-4°', status: 'elevated' },
  { name: 'FMA Angle', value: 27.8, unit: 'degrees', normalRange: '22-28°', status: 'normal' },
  { name: 'IMPA', value: 95.1, unit: 'degrees', normalRange: '90-97°', status: 'normal' },
  { name: 'Interincisal Angle', value: 128.4, unit: 'degrees', normalRange: '125-135°', status: 'normal' },
  { name: 'Upper Lip to E-line', value: -2.1, unit: 'mm', normalRange: '-4 to -2mm', status: 'normal' },
  { name: 'Lower Lip to E-line', value: 0.5, unit: 'mm', normalRange: '-2 to 0mm', status: 'elevated' },
  { name: 'Nasolabial Angle', value: 98.0, unit: 'degrees', normalRange: '90-110°', status: 'normal' },
  { name: 'Overbite', value: 3.5, unit: 'mm', normalRange: '2-4mm', status: 'normal' },
  { name: 'Overjet', value: 4.8, unit: 'mm', normalRange: '2-4mm', status: 'elevated' },
];
...
export default function OrthodonticPage() {
  ...
  const rawMeasurements = !isDemo && analysisResult?.measurements?.cephalometric?.length
    ? analysisResult.measurements.cephalometric
    : defaultMeasurements;
  ...
  const measurements = rawMeasurements.map((m) => ({
    ...m,
    value: editedValues[m.name] !== undefined ? editedValues[m.name] : m.value,
  }));
